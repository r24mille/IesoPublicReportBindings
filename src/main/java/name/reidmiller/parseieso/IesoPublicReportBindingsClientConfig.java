...
import name.reidmiller.parseieso.client.AdequacyClient;
...
@Configuration
public class IesoPublicReportBindingsClientConfig {
	static Logger logger = LogManager
			.getLogger(IesoPublicReportBindingsClientConfig.class.getName());
