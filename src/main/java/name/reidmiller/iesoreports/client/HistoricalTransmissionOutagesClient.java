...
public class HistoricalTransmissionOutagesClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public HistoricalTransmissionOutagesClient(String defaultUrlString, String jaxb2ContextPath) {
