...
public class DispatchAreaOperatingReserveShortfallsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public DispatchAreaOperatingReserveShortfallsClient(String defaultUrlString, String jaxb2ContextPath) {
