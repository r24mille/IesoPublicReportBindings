...
public class TraPostAuctionMcpLtRoundTwoClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public TraPostAuctionMcpLtRoundTwoClient(String defaultUrlString, String jaxb2ContextPath) {
