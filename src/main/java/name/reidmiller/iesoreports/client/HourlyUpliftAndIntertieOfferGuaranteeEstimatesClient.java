...
public class HourlyUpliftAndIntertieOfferGuaranteeEstimatesClient {
	private URL url;
	private Marshaller marshaller;
	private Unmarshaller unmarshaller;

	public HourlyUpliftAndIntertieOfferGuaranteeEstimatesClient(URL url, Marshaller marshaller,
