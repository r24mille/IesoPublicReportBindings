...
public class TraPostAuctionMcpStRoundOneClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public TraPostAuctionMcpStRoundOneClient(String defaultUrlString, String jaxb2ContextPath) {
