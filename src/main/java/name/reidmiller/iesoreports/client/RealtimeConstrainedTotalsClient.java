...
public class RealtimeConstrainedTotalsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public RealtimeConstrainedTotalsClient(String defaultUrlString, String jaxb2ContextPath) {
