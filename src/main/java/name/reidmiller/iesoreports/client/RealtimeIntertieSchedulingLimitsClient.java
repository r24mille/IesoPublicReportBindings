...
public class RealtimeIntertieSchedulingLimitsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public RealtimeIntertieSchedulingLimitsClient(String defaultUrlString, String jaxb2ContextPath) {
