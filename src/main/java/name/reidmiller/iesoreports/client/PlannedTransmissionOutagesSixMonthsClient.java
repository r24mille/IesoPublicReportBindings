...
public class PlannedTransmissionOutagesSixMonthsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public PlannedTransmissionOutagesSixMonthsClient(String defaultUrlString, String jaxb2ContextPath) {
