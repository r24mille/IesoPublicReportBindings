...
public class TrHourlyZonalPriceMonthlyClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public TrHourlyZonalPriceMonthlyClient(String defaultUrlString, String jaxb2ContextPath) {
