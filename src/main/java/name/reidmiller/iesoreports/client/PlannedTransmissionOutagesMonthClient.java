...
public class PlannedTransmissionOutagesMonthClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public PlannedTransmissionOutagesMonthClient(String defaultUrlString, String jaxb2ContextPath) {
