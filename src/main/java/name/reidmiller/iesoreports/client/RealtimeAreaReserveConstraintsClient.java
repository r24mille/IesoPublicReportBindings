...
public class RealtimeAreaReserveConstraintsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public RealtimeAreaReserveConstraintsClient(String defaultUrlString, String jaxb2ContextPath) {
