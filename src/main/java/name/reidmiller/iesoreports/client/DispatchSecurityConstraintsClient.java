...
public class DispatchSecurityConstraintsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public DispatchSecurityConstraintsClient(String defaultUrlString, String jaxb2ContextPath) {
