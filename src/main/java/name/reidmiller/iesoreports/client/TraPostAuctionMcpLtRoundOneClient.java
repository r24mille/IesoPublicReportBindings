...
public class TraPostAuctionMcpLtRoundOneClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());
	private String defaultUrlString;
	private String jaxb2ContextPath;

	public TraPostAuctionMcpLtRoundOneClient(String defaultUrlString, String jaxb2ContextPath) {
