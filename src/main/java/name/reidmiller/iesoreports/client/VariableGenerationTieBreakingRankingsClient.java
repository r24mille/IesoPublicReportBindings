...
public class VariableGenerationTieBreakingRankingsClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public VariableGenerationTieBreakingRankingsClient(String defaultUrlString, String jaxb2ContextPath) {
