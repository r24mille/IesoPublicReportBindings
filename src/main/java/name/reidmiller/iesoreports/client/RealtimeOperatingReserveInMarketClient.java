...
public class RealtimeOperatingReserveInMarketClient extends BaseReportClient {
	private Logger logger = LogManager.getLogger(this.getClass());

	public RealtimeOperatingReserveInMarketClient(String defaultUrlString, String jaxb2ContextPath) {
